...
public class ActivityMainBinding extends android.databinding.ViewDataBinding  {
    ...
    // views
    @Nullable
    public final xyz.elfanrodhian.myfamilylocator.databinding.ContentMainBinding contentMain;
    @NonNull
    ...
    public ActivityMainBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.contentMain = (xyz.elfanrodhian.myfamilylocator.databinding.ContentMainBinding) bindings[1];
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeContentMain((xyz.elfanrodhian.myfamilylocator.databinding.ContentMainBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeContentMain(xyz.elfanrodhian.myfamilylocator.databinding.ContentMainBinding ContentMain, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    public static ActivityMainBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityMainBinding>inflate(inflater, xyz.elfanrodhian.myfamilylocator.R.layout.activity_main, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityMainBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(xyz.elfanrodhian.myfamilylocator.R.layout.activity_main, null, false), bindingComponent);
    }
    @NonNull
